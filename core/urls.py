...
from . import views
from .views import historial_compras, actualizar_estado_pedido
...
urlpatterns = [
    ...
    path('actualizar-estado-pedido/<int:pedido_id>/', actualizar_estado_pedido, name='actualizar_estado_pedido'),
